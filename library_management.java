...
public class library_management {
	...
	Node insertRec(Node root, String key) {
		...
		else if (key.compareTo(root.key) > 0) // If book name > 1root then place it as Right child
	...
	public static void main(String[] args) throws Exception {
		...
		// Add student Details
		array[0] = new Student("Abhishek", 210231003, "MCA");
		array[1] = new Student("Sarvesh", 210231055, "B.Tech-ICT");
		array[2] = new Student("Waseem", 210231032, "MCA");
						...
						switch (ch3) {
									...
									if (array[index].book_no == 2) {
										...
										if (x == true) {
											...
											if (arr[a][1] > 0) {
												...
												Cday = cal.getTime();
												System.out.println(
														"Currunt Date Time : " + formatter.format(cal.getTime()));
							...
							case 2:// to return a book
								...
								try {
									...
									for (int k = 0; k < 3; k++) {
										if (array[k].id_no == s_id && (array[k].book1.equalsIgnoreCase(Rbook) == true
												|| array[k].book2.equalsIgnoreCase(Rbook) == true))
											ind = k;
									...
									if (ind != -1) {
										...
										if (y == true) {
											...
											if (Rday2.after(Rday1)) {
												...
												System.out
														.println("book is delayed by " + noofdays + "seconds." + diff);
